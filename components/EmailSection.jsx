    ...
    <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative" id="contact" >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/Yatharth2609">
            <Image src={GitHubIcon} />
          </Link>
          <Link href="https://www.linkedin.com/in/yatharth-mishra-03429a18b/">
      ...
      <div>
        <form className="flex flex-col" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="bg-purple-500 hover:bg-purple-600 text-white font-medium py-2.5 px-5 rounded-lg w-full border"
          >
            Send Message
          </button>
          {emailSubmitted && (
